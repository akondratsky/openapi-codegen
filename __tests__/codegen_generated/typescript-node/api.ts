...
export class NodeType {
    ...
    static getAttributeTypeMap() {
        return NodeType.attributeTypeMap;
    }
}
...
export class SearchNodesParams {
    'id': string;
    ...
    static getAttributeTypeMap() {
        return SearchNodesParams.attributeTypeMap;
    }
}
...
export class NodesApi {
     ...
     * @param id 
     */
    public getNodeById (id: string) : Promise<{ response: http.IncomingMessage; body: Node;  }> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getNodeById.');
        }
     ...
     */
    public searchNodes (searchNodesParams?: SearchNodesParams) : Promise<{ response: http.IncomingMessage; body: Nodes;  }> {
        const localVarPath = this.basePath + '/nodes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(searchNodesParams, "SearchNodesParams")
        };
        ...
        return new Promise<{ response: http.IncomingMessage; body: Nodes;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * Create nodes
     */
    public nodesPut () : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/nodes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * Update nodes
     */
    public nodesPatch () : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/nodes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
...
export class CollectionsApi {
     ...
     */
    public getAllCollections () : Promise<{ response: http.IncomingMessage; body: Collections;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: Collections;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
